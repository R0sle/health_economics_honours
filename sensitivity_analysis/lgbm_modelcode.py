...
val_data_file = 'country_data/val_' + sensitivity + '_inc.pkl'
...
#save best model 
joblib.dump(study.best_params, f"lgb_country/{sensitivity}/best_params_{fold}_{thresh}_{features}.pkl")

# Save study for later visualization
joblib.dump(study, f"lgb_country/{sensitivity}/optuna_study_{fold}_{thresh}_{features}.pkl")
...
with open(f"lgb_country/{sensitivity}/results_{fold}_{thresh}_{features}.json", "w") as f:
