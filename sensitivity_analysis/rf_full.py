...
#save best model 
joblib.dump(study.best_params, f"{sensitivity}/rf/best_params_{fold}_{thresh}_{features}.pkl")

# Save study for later visualization
joblib.dump(study, f"{sensitivity}/rf/optuna_study_{fold}_{thresh}_{features}.pkl")
...
with open(f"{sensitivity}/rf/results_{fold}_{thresh}_{features}.json", "w") as f:
